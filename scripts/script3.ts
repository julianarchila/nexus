...
const mockGongWebhook = [
    {
        ...
        parties: [
            ...
            { id: "9048546196233268852", emailAddress: "juan.perez@yuno.com", name: "Juan Pérez", title: "Sales Director", userId: "3022101605611220443", affiliation: "Internal", methods: ["Attendee"] }
        ],
        content: {
            trackers: [
        ...
        interaction: {
            speakers: [
                { id: "9048546196233268852", userId: "7041101707613290443", talkTime: 800 },
        ...
        collaboration: {
            publicComments: [
                { id: "2255211009900224216", audioStartTime: 900, audioEndTime: 900, commenterUserId: "7041101707613290443", comment: "El merchant confirma interés y solicita cronograma de onboarding.", posted: "2025-12-27T14:30:00-05:00", inReplyTo: null, duringCall: true }
            ]
        },
